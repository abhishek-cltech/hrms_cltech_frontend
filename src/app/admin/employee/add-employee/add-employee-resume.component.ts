...
import { Address, Experience, Education, Language, Project, Skill, EmployeeResume, EmployeeDetail, SocialMediaLink } from 'src/app/main/shared/employee-resume';
...
@Component({
  ...
  templateUrl: './add-employee-resume.component.html',
  styleUrls: ['./add-employee-resume.component.css']
})
